    ...
    <Layout>
      ...
      <div className="container main-content" style={{ marginTop: "32px" }}>
        ...
        <p>
          ...
          βασίζεται ιδιαίτερα στη σχέση που αναπτύσσεται μεταξύ θεραπευτή και
          θεραπευόμενου καθώς και στη μεταξύ τους συνεργασία. Η συνεργασία αυτή,
          δεν μπορεί να επιτευχθεί χωρίς εμπιστοσύνη, κατανόηση και ασφάλεια
          ανάμεσα σε θεραπευτή και θεραπευόμενο. Κύριο μέλημα του θεραπευτή, δεν
          είναι να ασκήσει κριτική, αλλά, να βοηθήσει τον θεραπευμένο να
          κατανοήσει τον εαυτό του. Και οι δυο λοιπόν, πορεύονται μαζί και
          συμμετέχουν ενεργά προκειμένου να ορίσουν από κοινού θεραπευτικούς
          στόχους για την βελτίωση της ζωής του θεραπευόμενου σε προσωπικό,
          εργασιακό επίπεδο κ.α.{" "}
        </p>
        <p>
